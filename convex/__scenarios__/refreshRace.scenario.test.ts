...
describe('scenario #7 — refresh race', () => {
  ...
  it(
    'two concurrent refresh attempts: only the winner calls Anthropic; loser sleeps, sees fresh tuple, aborts silently',
    async () => {
      const t = vault()
